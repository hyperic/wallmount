// only modification to this file is to change the constructor
// to allow explicit setting for width and height.
// size from dojo.marginBox doesn't work every time.

dojo.provide("hyperic.charting.Chart2D");
...
(function(){
	...
	dojo.declare("hyperic.charting.Chart2D", null, {
		//	summary:
		...
		constructor: function(/* DOMNode */node, /* dojox.charting.__Chart2DCtorArgs? */kwArgs, width, height){
			//	summary:
			...
			this.surface = dojox.gfx.createSurface(this.node, width || box.w || 400, height || box.h || 300);
		},
		destroy: function(){
			//	summary:
